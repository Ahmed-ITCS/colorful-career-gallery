...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-800 text-gray-200 py-12 border-t border-gray-700">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-xl font-bold mb-4 text-white">Ahmed Khawar</h3>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={i}>
                  <a 
                    href={link.href} 
                    className="text-gray-400 hover:text-portfolio-light-teal transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a 
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center bg-gray-700 hover:bg-portfolio-teal transition-colors"
              >
